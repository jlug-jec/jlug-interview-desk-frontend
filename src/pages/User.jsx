    ...
    <div className='bg-[#ECECEC] h-screen w-full p-10 mb-11'>
      ...
      <div className='flex flex-row w-full gap-2 mt-10'>
        <div className=' w-[25vw]  bg-white flex flex-col rounded-md shadow-lg  gap-8 items-center p-5'>
            <img src={userData.dp} className="w-[12vw] h-[12vw]  border-8 border-double border-spacing-3 border-zinc-500 mt-7  rounded-full" alt="" />
          ...
          <div className='flex flex-col gap-2'>
            <h4 className='text-xl text-center font-semibold'>{userData.name} {userData.gender === 'male' ? '(M)' : '(F)'}</h4>
            <h4 className='text-sm text-center font-semibold'>{userData.branch}</h4>
            <ul className='flex flex-col gap-5'>
              <li className='flex'><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/location-04-stroke-rounded.svg?alt=media&token=0b209a08-ed9f-480a-9a35-2f347f958a34" alt="" />{userData.loc || 'Not specified'}</li>
              <li><a className='flex' href={userData.port || '#'}><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/job-link-stroke-rounded.svg?alt=media&token=540b520a-a97c-440a-b0f2-892b25af241b" alt="" />{userData.port || 'No Portfolio'}</a></li>
              <li className='flex'><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/mail-01-stroke-rounded.svg?alt=media&token=9d3e616a-809e-4365-991f-e46f58509a1a" alt="" />{userData.email}</li>
              <li className='flex'><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/whatsapp-stroke-rounded.svg?alt=media&token=a97f5718-255e-46d0-bdd2-70b22b3b66e9" alt="" />{userData.contact}</li>
            </ul>
          </div>
        </div>
