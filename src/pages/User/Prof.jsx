      ...
      <div className='flex flex-row w-full gap-2 mt-10'>
          <div className=' w-[25vw]  bg-white flex flex-col rounded-md shadow-lg  gap-8 items-center '>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <ul className=' flex flex-col gap-5'>
                    <li className='flex'><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/location-04-stroke-rounded.svg?alt=media&token=0b209a08-ed9f-480a-9a35-2f347f958a34" alt="" />{user.loc}</li>
                    <li><a className='flex' href={user.port}><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/job-link-stroke-rounded.svg?alt=media&token=540b520a-a97c-440a-b0f2-892b25af241b" alt="" />Portfolio</a></li>
                    <li><a className='flex' href={user.email}><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/mail-01-stroke-rounded.svg?alt=media&token=9d3e616a-809e-4365-991f-e46f58509a1a" alt="" />Mail</a></li>
                    <li><a className='flex' href={user.contact}><img className='mr-2' src="https://firebasestorage.googleapis.com/v0/b/user-assets-6616a.appspot.com/o/whatsapp-stroke-rounded.svg?alt=media&token=a97f5718-255e-46d0-bdd2-70b22b3b66e9" alt="" />Whatsapp</a></li>
                </ul>
            </div>
          ...
          <div className=' w-[68vw] bg-white shadow-lg rounded-lg'>
            ...
            <ul className='bg-[#ECECEC] py-2 px-4 m-5 rounded-lg'>
                <li className='m-2'> <span className='text-green-400 border-green-400 border-2 rounded-lg px-2 absolute right-[10vw]'>Completed</span></li>
                <li className='m-2'><span className='text-green-400 border-green-400 border-2 rounded-lg px-2 absolute right-[10vw] '>Completed</span></li>
            </ul>
