        ...
        <div className="bg-white m-auto w-[95%] min-h-[70vh] flex flex-col p-10 rounded-xl drop-shadow-lg">
          {data.length > 0 ? (
            <div role="list" className="flex flex-col gap-4">
              {data.map((bookmark) => (
                <div key={bookmark.name} className="flex justify-between items-center gap-x-6 py-4 w-full min-h-[10px]">
                  ...
                  <div className={`flex items-center justify-between ${bookmark.net < 10 ? 'gap-6' : 'gap-4'}`}>
